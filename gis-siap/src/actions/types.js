...
//KLAIM
export const CREATE_KLAIM = "CREATE_KLAIM";
export const GET_KLAIM = "GET_KLAIM";
export const GET_KLAIM_USER = "GET_KLAIM_USER";
export const GET_KLAIM_ID = "GET_KLAIM_ID";
export const UPDATE_KLAIM = "UPDATE_KLAIM";
